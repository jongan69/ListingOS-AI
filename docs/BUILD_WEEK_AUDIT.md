...
| Demo video compliance | Red | No master render exists. The earlier automated renders were abandoned along with the synthetic-narration approach; the video is in pre-production against a 2:40-2:55 script with the founder's real voice. A publish-footage blocker is unresolved. | Resolve the publish-footage blocker in ListingOS-Hackathon-Demo-Assets/PRODUCTION_PLAN.md section 4, shoot, edit, upload to YouTube, confirm audio covers what was built plus Codex and GPT-5.6 usage, and verify visibility in an incognito window before submission. |
| Codex and GPT-5.6 evidence | Green | [README.md](../README.md), [DEVPOST_SUBMISSION.md](DEVPOST_SUBMISSION.md), [DEMO_VIDEO_SCRIPT_V2.md](../ListingOS-Hackathon-Demo-Assets/DEMO_VIDEO_SCRIPT_V2.md), and [CLAIMS.md](CLAIMS.md) consistently describe Codex workflow contribution and GPT-5.6 usage through the OpenAI Responses API. | Reuse that same wording in Devpost so the judges see one consistent story across the repo, video, and form fields. |
